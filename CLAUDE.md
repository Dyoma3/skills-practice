...
For all work in this AdonisJS backend, read and follow the local Claude Code skill at
[`.claude/skills/adonis-v7-backend/SKILL.md`](.claude/skills/adonis-v7-backend/SKILL.md) for generic
...
[`.claude/skills/adonis-v7-backend/references/`](.claude/skills/adonis-v7-backend/references/) as
directed by the skill and as relevant to the task.
...
- Use Zod and [`lib/request_validator.ts`](lib/request_validator.ts) for application input
  contracts. Preserve Vine where the Adonis framework bootstrap or an existing feature already
  requires it.
...
- Never hand-edit generated files under [`.adonisjs/`](.adonisjs/) or
